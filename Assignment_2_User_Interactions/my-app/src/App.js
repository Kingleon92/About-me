...
<img src="armypic.png" alt="Army/Family" />

{ /* "Vacation" by Dirty Heads */ }
<div className="myDiv">
    <h3>Vacation - Dirty Heads</h3>
    <audio controls autoPlay>
        <source src="Dirty Heads - Vacation (Official Video).mp3" type="audio/mp3" />
